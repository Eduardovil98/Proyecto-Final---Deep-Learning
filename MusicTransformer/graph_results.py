...
# graph_results
def graph_results(input_dirs="./saved_models_8layers/results", output_dir=None, model_names=None, epoch_start=0, epoch_end=None):
    """
    ----------
    Author: Damon Gwinn
    ----------
...
def main():
    ...
    args = parse_args()
    # args.input_dirs = './saved_models_8layers/results'
    # args.input_dirs = './rpr/results'
    args.input_dirs = './saved_models/results'
    if(not args.legacy):
