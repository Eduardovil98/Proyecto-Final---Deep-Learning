...
## TODO
* Write o[music_transformer.py](model%2Fmusic_transformer.py)wn midi pre-processor (sustain pedal errors with jason's)
   * Support any midi file beyond Maestro
* Fixed length song generation[music_transformer.py](model%2Fmusic_transformer.py)
