...
def prep_maestro_midi(maestro_root, output_dir):
    ...
    maestro_json_file = r'C:\Users\WIA5056\Documents\Maestria-CIMAT\3ER-SEMESTRE\02 - Deep Learning\Proyecto_Final\New folder (2)\MusicTransformer-Pytorch-master\dataset\FILES.csv'
    ...
    maestro_json_file = r'C:\Users\WIA5056\Documents\Maestria-CIMAT\3ER-SEMESTRE\02 - Deep Learning\Proyecto_Final\New folder (2)\MusicTransformer-Pytorch-master\dataset\FILES.csv'
    maestro_ = open(maestro_json_file, "r")
    ctns = maestro_.readlines()
    maestro_.close()
    midi_path = r'C:\Users\WIA5056\Documents\Maestria-CIMAT\3ER-SEMESTRE\02 - Deep Learning\Proyecto_Final\New folder (2)\MusicTransformer-Pytorch-master\dataset\TheBeatles_midi'
    for file in ctns:
        file = file.replace("\n", "").split(',')
        print(file)
        mid = midi_path + "\\" + file[1]
        split_type = file[0]
        print("Split:", split_type)
        f_name = file[1] + ".pickle"
...
def main():
    ...
    # args            = parse_args()
    # root    = args.root
    root = r'C:\Users\WIA5056\Documents\Maestria-CIMAT\3ER-SEMESTRE\02 - Deep Learning\Proyecto_Final\New folder (2)\MusicTransformer-Pytorch-master\dataset\TheBeatles_midi'
    # output_dir      = args.output_dir
    output_dir = r'C:\Users\WIA5056\Documents\Maestria-CIMAT\3ER-SEMESTRE\02 - Deep Learning\Proyecto_Final\New folder (2)\MusicTransformer-Pytorch-master\dataset\e_piano'
